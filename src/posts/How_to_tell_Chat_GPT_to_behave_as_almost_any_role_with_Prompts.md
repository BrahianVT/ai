---
title: "How to tell ChatGPT and Bard to behave as almost any role with Prompts"
date: "2023-07-22"
thumb: "prompt.PNG"
tags: [Others, Prompts]
---

# How to tell ChatGPT and Bard to behave as almost any role with Prompts

Looking on the net I've found a interesting topic about role-Prompts I'd like to share with you [here](https://github.com/f/awesome-chatgpt-prompts)

If you don't know what is a Prompts or how to use it, check this:  

[Basics of Prompting and how to use in ChatGPT and Bard](/Basics_of_Prompting_and_how_to_use_in_ChatGPT_and_Bard/)  
[Awesome Blog Prompts for ChatGPT and Bard](/Awesome_Blog_Prompts_for_ChatGPT_and_Bard/)  
[Keyword Research](/Awesome_Keyword_Research_Prompts_for_ChatGPT_and_Bard/)  
[Rewriting](/Awesome_Rewriting_Paragraphs_Prompts_for_ChatGPT_and_Bard/)  
[Awesome Prompts](/Awesome_prompts_for_ChatGPT_and_Bard)  

Also we can indicate to chatGPT and Bard to  behave as almost any role: examples click on title to expand: 


<table border="1">
 <tr>
    <td><b style="font-size:30px"> Role-Prompt</b></td>
    <td><b style="font-size:30px">Role-Prompt</b></td>
 </tr>
 <tr>
    <td>
...
I guess with all these examples you can get an idea about hot to use it with any role, here Sky's the limit.
